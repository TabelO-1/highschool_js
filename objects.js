...
// Lab 54
//Favorite subjects - list 3 in the form of an array
//Friends/family - list 2 friends or family members in 
//an array of objects, each object should contain the 
//persons name (ie: let family = [{ name: 'mom' }, { name: 'dad' })])
let favoriteSubjects = ['Math', 'Global History', 'Art 1']
let freindsAndFamily = [{
    Freind: 'Riley',
    Family: 'Parents',
    SpecialFamily: 'THE PUGGLE DOGGGGGGGGGGGGGGGGGGGGGGGGGGGGG3'
}]